...
class BEVF_FasterRCNN(MVXFasterRCNN):
    ...
    def extract_feat(self, points, img, img_metas, gt_bboxes_3d=None):
        ...
        if self.lift:
            # print("img_feats_shape:", img_feats.shape)
            # print("img_feats_size:", img_feats.size())
            # print("img_feats[0]_shape:", img_feats[0].shape)
            # print("img_feats[0]_size:", img_feats[0].size())
