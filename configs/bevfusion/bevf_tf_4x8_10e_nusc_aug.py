...
# load_from = './work_dirs/transfusion_nusc_voxel_L/transfusion_voxel_epoch_20.pth'
# load_lift_from = 'models/cam_tf_e20.pth'
load_lift_from = './work_dirs/bevf_tf_4x8_20e_nusc_cam_lr/bevf_tf_4x8_20e_nusc_cam_lr/epoch_20.pth'

resume_from = None
# resume_from = 'work_dirs/bevf_tf_4x8_10e_nusc_aug/bevf_tf_4x8_10e_nusc_aug/epoch_9.pth'
workflow = [('train', 1)]
gpu_ids = range(0, 4)
...
checkpoint_config = dict(interval=1, out_dir='./work_dirs/bevf_tf_4x8_10e_nusc_aug8')
work_dir = './work_dirs/bevf_tf_4x8_10e_nusc_aug8'
